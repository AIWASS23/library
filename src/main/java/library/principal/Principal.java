package library.principal;

import library.dto.AutorDTO;
import library.model.Autor;
import library.model.Idioma;
import library.model.Livro;
import library.model.RecordLivro;
...
import library.service.ConsumoApi;
import library.service.ConverteDados;
...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        while (opcao!= 9) {
            var menu = """
                    ...
                    2- Visualizar lista de livros registrados
                    3- Visualizar lista de autores registrados
                    4- Visualizar lista de autores vivos em um determinado ano
                    5- Visualizar lista de livros em um determinado idioma
                    6- Ver os top 10 livros mais baixados
                    9- Sair
    ...
    public void buscaLivroOpen(){
        ...
        RecordLivro listaRt = conversor.obterDados(json, RecordLivro.class);
